    ...
    <div class="box form-box">
        ...
        if(isset($_POST['submit'])){
            ...
            if($edit_query){
                 ...
                 <p>Profil guncellendi</p>
                 </div><br>";
                 echo "<a href='profil.php' ><button class='btn'>Profile git</button>";
        ...
        ?>
        <header>profili degistir</header>
